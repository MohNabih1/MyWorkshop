...
public class Order {
  ...
  public Order(BufferedReader reader) throws IOException {
    ...
    public void save(BufferedWriter writer) throws IOException {
        writer.write(Integer.toString(items.size()));
        writer.newLine();
        for (Item item : items) {
            item.save(writer);
        }
        // Additional fields like orderNumber could be saved as well
    }
    /**
